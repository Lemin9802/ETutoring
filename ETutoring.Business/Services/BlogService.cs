...
namespace ETutoring.Business.Services
{
    public class BlogService : IBlogService
    {
        ...
        public async Task<List<GetAllBlogRequest>> GetAllBlogsAsync(Guid currentUserId, CancellationToken cancellationToken)
        {
            return await _context.Blogs
                ...
                .Select(b => new GetAllBlogRequest
                {
                    ...
                    IsLiked = _context.BlogLikes.Any(bl => bl.BlogId == b.Id && bl.UserId == currentUserId)
                })
        ...
        public async Task<List<GetAllBlogRequest>> GetBlogByIdAsync(Guid userId, CancellationToken cancellationToken)
        {
            return await _context.Blogs
                ...
                .Select(b => new GetAllBlogRequest
                {
                    ...
                    UserFullName = b.User.FullName,
                    CreatedAt = b.CreatedAt,
                    IsLiked = _context.BlogLikes.Any(bl => bl.BlogId == b.Id && bl.UserId == userId)
                })
                .ToListAsync(cancellationToken);
        }
