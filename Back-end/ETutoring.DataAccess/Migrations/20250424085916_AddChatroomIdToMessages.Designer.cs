...
namespace ETutoring.DataAccess.Migrations
{
    ...
    [Migration("20250424085916_AddChatroomIdToMessages")]
    partial class AddChatroomIdToMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETutoring.Core.Entities.BlogLike", b =>
                {
                    b.Property<Guid>("BlogId")
                        .HasColumnType("uuid")
                        .HasColumnName("blog_id");
            ...
            modelBuilder.Entity("ETutoring.Core.Entities.MeetingAttendee", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_meeting_attendee_user_id");
            ...
            modelBuilder.Entity("ETutoring.Core.Entities.BlogLike", b =>
                {
                    b.HasOne("ETutoring.Core.Entities.Blog", "Blog")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_blog_likes_blogs_blog_id");
            ...
            modelBuilder.Entity("ETutoring.Core.Entities.MeetingAttendee", b =>
                {
                    b.HasOne("ETutoring.Core.Entities.Meeting", "Meeting")
                        .WithMany("Attendees")
                        .HasForeignKey("MeetingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_meeting_attendee_meetings_meeting_id");
                    ...
                    b.HasOne("ETutoring.Core.Entities.ApplicationUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_meeting_attendee_users_user_id");
